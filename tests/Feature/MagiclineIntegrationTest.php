...
namespace alexbabintsev\Magicline\Tests\Feature;

use alexbabintsev\Magicline\Magicline;
use alexbabintsev\Magicline\Tests\TestCase;
use Illuminate\Support\Facades\Http;

class MagiclineIntegrationTest extends TestCase
{
    public function test_magicline_can_be_resolved_from_container()
    {
    ...
    public function test_magicline_facade_works()
    {
        Http::fake([
    ...
    public function test_all_resources_are_accessible()
    {
        $magicline = app(Magicline::class);
